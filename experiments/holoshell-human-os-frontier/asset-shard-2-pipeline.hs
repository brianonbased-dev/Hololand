...
object "AssetShardPipelineV2Manifest" {
  ...
  roomSource: "experiments/holoshell-human-os-frontier/asset-shard-2-room.holo"
  policySource: "experiments/holoshell-human-os-frontier/asset-shard-2-policy.hsplus"
...
object "AssetShardValidateStep" {
  ...
  permissionEnvelope: "read_only"
  outputs: [".tmp/holoshell/shard-preview.holo", "experiments/holoshell-human-os-frontier/asset-shard-2-room.holo", "experiments/holoshell-human-os-frontier/asset-shard-2-policy.hsplus"]
}
