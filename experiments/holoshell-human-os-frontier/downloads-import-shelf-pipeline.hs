...
object "DownloadsImportShelfPipelineManifest" {
  ...
  roomSource: "experiments/holoshell-human-os-frontier/downloads-import-shelf-room.holo"
  policySource: "experiments/holoshell-human-os-frontier/downloads-import-shelf-policy.hsplus"
  ...
  evidencePack: ".bench-logs/holoshell-human-os-frontier/2026-05-19/downloads-import-shelf-evidence-pack.md"
}
...
object "InventoryScanStep" {
  ...
  order: 2
  action: "scan_files_without_opening_private_content"
  permissionEnvelope: "read_only"
