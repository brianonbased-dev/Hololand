...
object "FamilyPhotoBackupCustodyPipelineManifest" {
  ...
  roomSource: "experiments/holoshell-human-os-frontier/family-photo-backup-custody-room.holo"
  policySource: "experiments/holoshell-human-os-frontier/family-photo-backup-custody-policy.hsplus"
...
object "AlbumInventoryStep" {
  ...
  output: ".tmp/holoshell/photo-backup-inventory-latest.json"
}
...
object "DedupeStep" {
  ...
  output: ".tmp/holoshell/photo-backup-dedupe-latest.json"
}
