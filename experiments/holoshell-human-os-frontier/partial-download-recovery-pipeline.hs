...
object "PartialDownloadRecoveryPipelineManifest" {
  ...
  roomSource: "experiments/holoshell-human-os-frontier/partial-download-recovery-room.holo"
  policySource: "experiments/holoshell-human-os-frontier/partial-download-recovery-policy.hsplus"
  parentWorkflow: "experiments/holoshell-human-os-frontier/downloads-import-shelf-pipeline.hs"
