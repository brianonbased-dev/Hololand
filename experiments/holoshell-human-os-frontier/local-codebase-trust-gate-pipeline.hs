...
object "LocalCodebaseTrustPipelineManifest" {
  ...
  roomSource: "experiments/holoshell-human-os-frontier/local-codebase-trust-gate-room.holo"
  policySource: "experiments/holoshell-human-os-frontier/local-codebase-trust-gate-policy.hsplus"
