...
- `apps/holoshell/source/holoshell-control-daemon-service.hsplus` promotes the HoloShell control daemon into a managed loopback service with verified PID custody and mutation execution disabled by default.
...
pnpm run holoshell:control-daemon-service:ensure
...
pnpm run test:holoshell-control-daemon-service
